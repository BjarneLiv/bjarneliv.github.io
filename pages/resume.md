...
- **2020 - 2021** - **Preparatory Training in Word Art-Drama (BVWKD)**  
...
- **2022 - Present** | **Various**  
  KASK, Ghent, Belgium  
  *Performances as part of the Academic Bachelor of Drama, collaborations and training with Sara de Bosschere, Jan Steen, Kuno Bakker, etc.*

### Part-Time Arts Education
- **2012 - 2019** | **Various**  
  Part-Time Arts Education, Evergem, Belgium  
...
- **2022** - **Supporting Lead Role** in **"De Date"**  
  Director: Mon Dewulf  
  *Short film in which I played a supporting lead role*

---

## Skills
- **Languages**: Dutch (native), English (fluent/native), French (basic)
- **Dialects**: Skilled at adopting and learning dialects quickly.
- **Physical Skills**: Athletic, good endurance.
- **Musical Skills**: Trumpet (jazz)
- **Alexander Technique**
- **Iyengar Yoga**
- **Voice Training**
- **Laban (Notation)**
- **Other Skills**: Swimming, running, cycling.

---

## References
- **Sara de Bosschere**  
  Teacher/Actress, De Roovers/tg Amsterdam/tg Stan/Wat als?  
  +32 497 82 84 26

- **El van Lancker**  
  Teacher, Part-Time Arts Education (DKO)  
  el.van.lancker@muziek-academie.be

- **Jan Steen**  
  Teacher/Actor/Head of Program, KASK  
  jan.steen@hogent.be
